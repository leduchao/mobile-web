...
public class ProductService : IProductService
{
    ...
    public async Task CreateAsync(ProductDTO request)
    {
        ...
        var newProduct = new Product
        {
            ...
            ImgUrl = SetFileName(request.ImgUrl!),
            Price = request.Price,
        ...
        await UploadImageAssync(request.ImgUrl!);
    ...
    public async Task UpdateAsync(int id, ProductDTO request)
    {
        ...
        if (existProduct != null)
        {
            ...
            var oldImg = existProduct.ImgUrl;
            ...
            if (specifications != null)
            {
                ...
                existProduct.ImgUrl = SetFileName(request.ImgUrl!);
                ...
                File.Delete(@"wwwroot\img\products\" + oldImg);
                await UploadImageAssync(request.ImgUrl!);
    ...
    public async Task UploadImageAssync(IFormFile file)
    {
        if (file != null)
        {
    ...
    public string SetFileName(IFormFile file) => $"{DateTime.Now:yyyyMMddhhmmss}_{Path.GetFileName(file.FileName)}";
}
