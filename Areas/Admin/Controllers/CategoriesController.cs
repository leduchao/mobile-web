...
//    public CategoriesController(MobileWebContext context)
//    {
//      _context = context;
//    }
...
//    {
//      return _context.Category_1 != null ?
//                  View(await _context.Category_1.ToListAsync()) :
...
//      {
//        return Problem("Entity set 'MobileWebContext.Category_1'  is null.");
//      }
//      var category = await _context.Category_1.FindAsync(id);
//      if (category != null)
//      {
...
//    {
//      return (_context.Category_1?.Any(e => e.Id == id)).GetValueOrDefault();
//    }
//  }
//}
